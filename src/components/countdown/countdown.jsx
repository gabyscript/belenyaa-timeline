...
const Countdown = ({ targetDate }) => {
  ...
  return (
    <Container className='countdown-container d-flex flex-column justify-content-center align-items-center' >
      <h2 className='text-center font-weight-bold'>Próximo evento 👀</h2>
      <Container className='d-flex flex-row justify-content-center align-items-center py-3'>
